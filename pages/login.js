...
import { useSession, getProviders, signOut, signIn, getCsrfToken } from 'next-auth/react'
                ...
                >
                  {({
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <input name="csrfToken" type="hidden" value={values.csrfToken} />
                      <div className="auth-box">
                        ...
                        <div className="row mb-20">
                            ...
                            <div className="col-sm-2">
                                <img src="/images/logo-1.png" alt="small-logo.png" />
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <p className="text-inverse text-left m-b-0">Silakan Masukan Data Anda.</p>
                            <p className="text-inverse text-left"><b>Bawaslu Republik Indonesia</b></p>
                          </div>
                        </div>
